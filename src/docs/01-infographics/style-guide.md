...
- #5B8FD4 — Blue (safety, security, trust)
- #E8765A — Coral (warnings, risks, alerts)
- #8B7AC8 — Violet (learning, memory, intelligence, transformation)
...
## 9. Color Decision Tree & Semantic Mapping

### When to Use Each Accent Color

**Emerald Green (#0D5F4E) — Primary Brand**
- ✓ Growth metrics and positive trends
- ✓ Success states and confirmations
- ✓ Primary CTAs and navigation
- ✓ Wellness and sustainability topics
- ✓ Strategic initiatives and opportunities

**Sage Green (#6B9D89) — Secondary**
- ✓ Supporting actions and links
- ✓ Subtle emphasis and highlights
- ✓ Section dividers and borders
- ✓ Neutral information displays
- ✓ Background accents (20-30% opacity)

**Gold (#C9A54A) — Value & Analysis**
- ✓ Financial metrics and ROI
- ✓ Luxury and premium positioning
- ✓ Analytics and data insights
- ✓ Performance benchmarks
- ✓ Investment and value propositions
...
**Coral (#E8765A) — Warnings & Risks**
- ✓ Alerts and important notices
- ✓ Risk factors and challenges
- ✓ Disruption and change indicators
- ✓ Urgent action items
- ✓ Negative trends (use sparingly)
...
**Teal (#3A8A7A) — Innovation & Operations**
- ✓ Wearables and technology integration
...
**Light Sections (Cream/Beige backgrounds)**
- Dark text: #191918 (near-black)
- Primary accent: Any accent at full saturation
- Secondary text: #1E3D33 (deep green) or #7C7D79 (gray)
- Card backgrounds: Accent color at 8-10% opacity
- Borders: Accent color at 20-30% opacity

**Dark Sections (#0A211F, #0E1A17, #162D26)**
- Primary text: #FAF9F7 (cream)
- Secondary text: #D4E6D0 (light sage)
- Tertiary text: #7C7D79 (gray)
- Accent colors: Use at full saturation for contrast
- Card backgrounds: Dark variants with subtle accent tints

### Harmonious Section Alternation

**Pattern for Multi-Section Pages:**

```
Hero: Dark (#0A211F) + Sage accent
  ↓
Section 1: Light (cream) + Coral/Gold/Blue
  ↓
Section 2: Dark + Violet/Teal
  ↓
Section 3: Light + Blue/Gold
  ↓
Section 4: Dark + Gold/Violet
  ↓
...
- Use warm accents (gold, coral) on light backgrounds
- Use cool accents (blue, violet, teal) on dark backgrounds
- Never use more than 2 accent colors per section
- Group related sections with similar accent colors

### Color Psychology Quick Reference

| Color | Emotion | Energy Level | Best For |
|-------|---------|--------------|----------|
| Emerald | Growth, Trust, Stability | Medium | Primary brand, success |
| Sage | Calm, Balance, Harmony | Low | Supporting elements |
| Gold | Value, Premium, Achievement | Medium-High | Finance, luxury, analytics |
| Blue | Trust, Security, Reliability | Low-Medium | Safety, information |
| Coral | Urgency, Importance, Action | High | Warnings, risks, alerts |
| Violet | Intelligence, Wisdom, Innovation | Medium | AI, learning, memory |
| Teal | Innovation, Clarity, Efficiency | Medium | Tech, operations, systems |

### Accessibility Contrast Ratios

**On Light Backgrounds (#FAF9F7, #F5F3EF):**
- Emerald (#0D5F4E): 7.8:1 ✓ AAA
- Gold (#C9A54A): 4.9:1 ✓ AA
- Blue (#5B8FD4): 4.2:1 ✓ AA (large text)
- Coral (#E8765A): 4.5:1 ✓ AA
- Violet (#8B7AC8): 5.1:1 ✓ AA
- Teal (#3A8A7A): 6.2:1 ✓ AA

**On Dark Backgrounds (#0A211F, #0E1A17):**
- All accent colors at full saturation: 5:1+ ✓ AA minimum
- Use #FAF9F7 for primary text: 15.2:1 ✓ AAA
- Use #D4E6D0 for secondary text: 11.4:1 ✓ AAA
